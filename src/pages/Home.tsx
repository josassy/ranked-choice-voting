...
const Home = () => (
  <div className="m-auto w-auto max-w-3xl p-12">
    ...
    <p className='my-4'>
      ...
      How the votes are counted depends on whether RCV is used to elect a single office, like a mayor or governor, or whether it is used to elect more than one position at once, like an at-large city council or a state legislature elected in a multi-winner district (<StyledA href='https://www.fairvote.org/rcv#how_rcv_works'>FairVote.org</StyledA>).
    </p>
    <div className="aspect-w-16 aspect-h-9">
      <iframe src="https://www.youtube.com/embed/8Z2fRPRkWvY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
